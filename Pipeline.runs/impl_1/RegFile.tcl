...
set rc [catch {
  ...
  set_property ip_repo_paths d:/ACAProject/Pipeline/Pipeline.cache/ip [current_project]
  set_property ip_output_repo d:/ACAProject/Pipeline/Pipeline.cache/ip [current_project]
  add_files -quiet D:/ACAProject/Pipeline/Pipeline.runs/synth_1/RegFile.dcp
  link_design -top RegFile -part xc7a100tcsg324-3
